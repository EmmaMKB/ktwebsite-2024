...
<html class="no-js" lang="en">
    <head>
        ...
        <!-- description -->
        <meta name="description" content="Kreative Touch est une agence branding et vidéo basée à Lubumbashi.
                            Nous combinons passion et créativité pour emmener votre marque au niveau supérieur.">
        <!-- keywords -->
        <meta name="keywords" content="branding, filmmaking, motion, design, graphic design, motion design, kreative, kreative touch, impression, animation">
        <!-- favicon -->
    ...
    <body class="bg-background-fade">
        ...
        <header>
            <!-- start navigation -->
            <nav class="navbar navbar-default bootsnav navbar-top-scroll background-transparent white-link padding-four-lr menu-logo-center navbar-expand-lg">
                <div class="container-lg nav-header-container">
                    <!-- start logo -->
                    <div class="center-logo">
                        <a href="{{ route('home') }}" title="Kreative Touch" class="logo"><img src="{{ asset('assets/images/logo.png') }}" data-at2x="{{ asset('assets/images/logo@2x.png') }}" class="logo-dark" alt="Kreative Touch"><img src="{{ asset('assets/images/logo-full-white.png') }}" data-at2x="{{ asset('assets/images/logo-full-white@2x.png') }}" alt="Kreative Touch" class="logo-light default"></a>
                    </div>
                    <!-- end logo -->
        ...
        <!-- end header -->
        <!-- start hero section -->
        <section class="wow animate__fadeIn p-0 cover-background color-code" data-color="1"  style="background-image: url('{{ asset('assets/images/bg1.png') }}');">
        ...
        <!-- end hero section -->
        <!-- start section -->
        <section class="wow animate__fadeIn color-code lg-no-background-img xs-padding-100px-bottom" data-color="2" style="background: url('{{ asset('assets/images/back-image1.png') }}') left bottom no-repeat,url('{{ asset('assets/images/back-image2.png') }}') right top no-repeat">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-9 col-md-10 text-center">
                        <div class="text-extra-small letter-spacing-3 alt-font text-white-2 text-uppercase margin-70px-bottom md-margin-50px-bottom sm-margin-30px-bottom d-inline-block">à propos de Kreative Touch</div>
                        <h3 class="text-white-2 alt-font w-100 margin-70px-bottom md-no-margin-bottom">Kreative Touch est une agence branding et vidéo basée à Lubumbashi.
                            Nous combinons passion et créativité pour emmener votre marque au niveau supérieur.
                        </h3>
                    </div>
                </div>
                    ...
                    <div class="col-lg-4 col-md-5 text-center text-white-2">
                        ...
                        <div class="social-icon-style-8 d-inline-block align-middle">
                            <ul class="small-icon mb-0">
                                <li><a class="facebook text-white-2" href="https://web.facebook.com/profile.php?id=100095293395086" target="_blank"><i class="fa-brands fa-facebook-f" aria-hidden="true"></i></a></li>
                                <li><a class="instagram text-white-2" href="https://www.instagram.com/kreativetouch_branding/" target="_blank"><i class="fa-brands fa-instagram me-0" aria-hidden="true"></i></a></li>
                                <li><a class="linkedin text-white-2" href="https://www.linkedin.com/company/kreative-touch-comms/" target="_blank"><i class="fa-brands fa-linkedin me-0" aria-hidden="true"></i></a></li>
                                <li><a class="youtube text-white-2" href="https://www.youtube.com/channel/UCbAV9rbLsGEMBHY-GIL6Iqg" target="_blank"><i class="fa-brands fa-youtube me-0" aria-hidden="true"></i></a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- end social media -->
